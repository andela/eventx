...
RSpec.describe Events::TicketsReportPresenter do
  ...
  describe '#ticket_types' do 
    it 'returns all ticket types for a valid event' do
      expect(@presenter.ticket_types.count).to eq 1  
    end 
  end 
