...
ActiveRecord::Schema.define(version: 20160316132226) do
  ...
  add_index "event_staffs",
            %w(user_id event_id),
            name: "index_event_staffs_on_user_id_and_event_id",
            unique: true
  ...
  add_index "user_tickets", ["booking_id"],
            name: "index_user_tickets_on_booking_id"
  add_index "user_tickets", ["ticket_type_id"],
            name: "index_user_tickets_on_ticket_type_id"
